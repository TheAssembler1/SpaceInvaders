...
static void execute_opcode(uint16_t opcode){
    switch(opcode){
        ...
        case 0x03: inx(registers, cpu_state, BC);  break;
        ...
        case 0x13: inx(registers, cpu_state, DE);  break;
        ...
        case 0x23: inx(registers, cpu_state, HL);  break;
        ...
        case 0x33: inx(registers, cpu_state, SP);  break;
