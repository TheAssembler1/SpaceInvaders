...
#define __LOG_BARE__(format, ...) printf(format, ## __VA_ARGS__)
...
#define log_log(format, ...)   __LOG_BARE__(format ## "\n", ## __VA_ARGS__)
...
#define log_log_nonewl(format, ...)	  __LOG_BARE__(format, ## __VA_ARGS__)
